...
budget_csv = os.path.join(wd_path,'Resources','budget_data.csv')
...
results_text=os.path.join(wd_path,'analysis','financial_analysis.txt')
analysis = open(results_text, 'w')
